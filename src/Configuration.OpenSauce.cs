...
using static HXE.OpenSauce.OpenSauceObjects.ObjectsWeapon.WeaponPositions;
using static HXE.OpenSauce.OpenSauceObjects.ObjectsWeapon.WeaponPositions.PositionWeapon;
  ...
  public partial class Configuration
  {
    public class ConfigurationOpenSauce : INotifyPropertyChanged
    {
      ...
      public void ApplyDOOM()
      {
        ...
        Configuration.Objects.Weapon.Positions.Weapon = new List<PositionWeapon>
        {
